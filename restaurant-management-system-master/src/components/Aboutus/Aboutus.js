...
import Images from "./../images/logo.jpeg";
...
const Aboutus = () => {
  return (
    ...
    <Link className="btn btn-light mx-1" to="/" role="button">
      ...
      <h3 className="about">
        Welcome To <span id="W_Name1">QScript Coffee</span>
      </h3>
      <div className="content">
      <p><b>
        <span id="W_Name2">QScript Coffee</span> is a Professional{" "}
      ...
      <div className="hero-logo">
                  <img src={Images} alt="QScript Coffee is busy"/>
              </div>
